...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="Agriculteur.html" class="dropdown-item">Agriculteur</a>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">Profil de l'acheteur</h1>
    ...
    <div class="container py-5">
        ...
        <button type="button" class="btn btn-primary mb-3">Modifier le Profil</button>
            ...
            <div class="col-md-8">
               ...
               <?php
// Assumez que vous êtes déjà connecté à la base de données ici
$host = "localhost";
    $dbname = "agrimarket";
    $username = "root";
    $password = "";
...
// La requête pour récupérer les commandes (veuillez adapter la requête à votre schéma de base de données)
$sql = "SELECT o.nom AS produit, c.quantite, a.login AS login_agriculteur, c.date_commande,c.etat_commande AS etat_commande
        FROM commandes c
        JOIN offres o ON c.produit_id = o.id
        JOIN agriculteur a ON c.login2 = a.login
        WHERE c.login = :loginAcheteur
        ORDER BY c.date_commande DESC";
$loginAcheteur = $_SESSION['login'];

$stmt = $conn->prepare($sql);
$stmt->bindParam(':loginAcheteur', $loginAcheteur, PDO::PARAM_STR);
$stmt->execute();
...
if ($stmt->rowCount() > 0) {
    ...
    echo '<thead>';
    echo '<tr>';
    echo '<th scope="col">Produit commandé</th>'; // Modifier le titre de la colonne
    echo '<th scope="col">Quantité</th>';
    echo '<th scope="col">Agriculteur</th>'; // Modifiez le titre de la colonne
    echo '<th scope="col">Date</th>';
    echo '<th scope="col">Etat de la commande</th>';
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        echo '<tr>';
        echo '<td>' . $row['produit'] . '</td>'; // Utilisez la nouvelle colonne pour le produit commandé
        echo '<td>' . $row['quantite'] . '</td>';
        echo '<td>' . $row['login_agriculteur'] . '</td>';
...
?>
                ...
                <!-- Bouton "Commander" -->
                <button type="button" class="btn btn-primary mt-3" onclick="window.location.href='Accueil.html'">Commander</button>
